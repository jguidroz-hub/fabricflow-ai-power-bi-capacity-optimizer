...
const FROM = process.env.EMAIL_FROM || 'FabricFlow AI - Power BI Capacity Optimizer <noreply@example.com>';
const APP_NAME = 'FabricFlow AI - Power BI Capacity Optimizer';
