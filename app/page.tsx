  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">FabricFlow AI - Power BI Capacity Optimizer</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Helps Power BI and Microsoft Fabric users proactively monitor, predict, and optimize their capacity usage to prevent throttling, improve performance, and reduce costs.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust FabricFlow AI - Power BI Capacity Optimizer.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} FabricFlow AI - Power BI Capacity Optimizer. All rights reserved.</p>
