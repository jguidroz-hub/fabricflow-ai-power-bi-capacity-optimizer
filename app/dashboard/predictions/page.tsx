...
export default function PredictionsPage() {
  const [items, setItems] = useState<PredictionsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Capacity Forecasts</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">AI-powered usage prediction and optimization</p>
