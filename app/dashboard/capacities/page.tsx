...
export default function CapacitiesPage() {
  const [items, setItems] = useState<CapacitiesItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/capacities/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-6">Monitor and manage Power BI/Fabric capacities</p>
